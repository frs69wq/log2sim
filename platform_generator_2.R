...
export_XML(all_site_ASes_max_lim, Max_links, Sites_to_from_SE_routes,"Max_Site")                          # Sec III.D

export_XML(all_site_ASes_corr_max_lim, Corr_Max_links, Sites_to_from_SE_routes,"Corr_Max_Site") # Sec III.E
